...
- Have an app such as SideQuest, to install the application on the **Quest 3**
- Requires a meta developer account attached to the device (https://developers.meta.com/horizon/)
